...
/// @brief		KAYACoaXpress Optronicsカメラ ver.440
/// @author		Mikihiro Ikura
/// @date		2020/10/26 作成
/// @date		2020/10/26 最終更新
/// @version	1.0.0
///

#include <HSC/KAYACoaXpressClass440.hpp>
#include <iostream>
...
kayacoaxpress::kayacoaxpress() : Camera(CAM_WIDTH, CAM_HEIGHT, CAM_FPS)
{
	...
	//カメラ数の確認
	status = KYFG_CameraScan(fg_handle, &cam_handle, &cam_detect_cnt);//ボード接続しているカメラすべて認識
}

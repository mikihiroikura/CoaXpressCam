...
#define  XI_PRM_ACQ_TIMING_MODE                 "acq_timing_mode"         // Type of sensor frames timing.
...
#define  XI_PRM_TRG_SELECTOR                    "trigger_selector"        // Selects the type of trigger.
...
#define  XI_PRM_HDR_T1                          "hdr_t1"                  // Exposure time of first slope(in % of XI_PRM_EXPOSURE)
#define  XI_PRM_HDR_T2                          "hdr_t2"                  // Exposure time of second slope(in % of XI_PRM_EXPOSURE)
...
#define  XI_PRM_HDR_CURVE_GAMMA                 "hdr_curve_gamma"         // Coefficient of HDR curve y = x pow hdr_curve_gamma, sets fixed exorure times XI_PRM_HDR_T1 and XI_PRM_HDR_T2, approximates XI_PRM_KNEEPOINT1 and XI_PRM_KNEEPOINT2
// 
...
// 
#define  XI_PRM_DEBUG_LEVEL                     "debug_level"             // Set debug level
...
typedef enum
{
	...
	XI_GPO_FRAME_TRIGGER_READY   =6, // On when sensor is ready for next trigger edge.
	XI_GPO_FRAME_TRIGGER_READY_NEG=7, // Off when sensor is ready for next trigger edge.

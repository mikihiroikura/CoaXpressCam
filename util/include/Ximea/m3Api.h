...
typedef enum {
	...
	SET_FRAME_TRIGGER_READY  = 0x009,		//!< set gpo to output ready for next trigger signal
	SET_FRAME_TRIGGER_READY_INV  = 0x00A,	//!< set gpo to output inverted ready for next trigger signal
	SET_EXPOSURE_PULSE  	= 0x00B,		//!< set gpo to output "strobe out" signal (integration 250us pulse)
	SET_EXPOSURE_PULSE_INV  = 0x00C,		//!< set gpo to output inverted "strobe out" (integration 250us pulse)
	// etc
} GPIO;
